      ...
      <div className="navs-container">
        <section className="info-links">
          <div className="links-container">
            <div className="link">
              <Image
                src={"/images/header/info/email.svg"}
                height={60}
                width={60}
                alt="email"
            ...
            <div className="link">
              <Image
                src={"/images/header/info/phone.svg"}
                height={60}
                width={60}
                alt="email"
                className="icon-header"
            ...
            <div className="link">
              <Image
                src={"/images/header/info/whatsapp.svg"}
                height={60}
                width={60}
                alt="email"
                className="icon-header"
            ...
            <div className="link social">
              <Image
                src={"/images/header/info/facebook.svg"}
                height={60}
                width={60}
                alt="email"
                className="icon-header"
              />
              <Image
                src={"/images/header/info/youtube.svg"}
                height={60}
                width={60}
                alt="email"
                className="icon-header"
              />
              <Image
                src={"/images/header/info/instagram.svg"}
                height={60}
                width={60}
                alt="email"
                className="icon-header"
        ...
        <section className="nav-links">
          <main className="navs">
            ...
            <div className="login">
              <Image
                src={"/images/header/navs/login.svg"}
                height={50}
                width={50}
                alt="user-logo"
                className="user-logo"
              />
              <strong>
                <Link href={ROUTES.Login}>Iniciar / Registrarse</Link>
              </strong>
            </div>
            <button className="btn-custom">
              <Link href={ROUTES.Appraisals}>Tasaciones</Link>
            </button>
            <Image
              src={"/images/header/navs/expand.svg"}
              height={50}
              width={50}
              alt="expand-logo"
