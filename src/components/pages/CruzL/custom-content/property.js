  ...
  return (
    <main className='property2'>
      ...
      <section className='img-container'>
        ...
        <Image src={'/images/custom/owner.png'} height={65} width={65} alt='property' className='owner-img'/>
        <Image src={'/images/CruzL/property2.png'} height={500} width={500} alt='property' className='img-property'/>
      </section>
